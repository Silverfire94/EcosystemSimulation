...
public class Fish extends Herbivore
{
     ...
     */
    public Fish(boolean randomAge,boolean male, Field field, Location location, Field islandField)
    {
    ...
    {
        return new Fish(randomAge, male, field, location, islandField);
    }
