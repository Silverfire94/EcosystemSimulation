...
public class SimulatorView extends JFrame
{
    ...
    private final String STEP_PREFIX = "NO_OF_DAYS: ";
     ...
     * @param stepInDay is the number of step in a day
     * @param primaryfield The field where the animal is stored.
     * @param secondaryfield the field where the land is stored.
     */ 
    public void showStatus(int step ,int stepInDay, Field primaryField, Field secondaryField)
    {
        if(!isVisible()) {
            setVisible(true);
        }
        
        stepLabel.setText(STEP_PREFIX + stepInDay +" NO OF STEPS :" + step);
        stats.reset();
